...
if __name__ == "__main__":
	...
	parser.add_argument("--voice_latents_chunks", type=int, default=default_arguments['voice_latents_chunks'])
	parser.add_argument("--candidates", type=int, default=default_arguments['candidates'])
	parser.add_argument("--seed", type=int, default=default_arguments['seed'])
	parser.add_argument("--num_autoregressive_samples", type=int, default=default_arguments['num_autoregressive_samples'])
	parser.add_argument("--diffusion_iterations", type=int, default=default_arguments['diffusion_iterations'])
	parser.add_argument("--temperature", type=float, default=default_arguments['temperature'])
	parser.add_argument("--diffusion_sampler", default=default_arguments['diffusion_sampler'])
	parser.add_argument("--breathing_room", type=int, default=default_arguments['breathing_room'])
	parser.add_argument("--cvvp_weight", type=float, default=default_arguments['cvvp_weight'])
